...
#dataset utils
def get_catg_mapping(C,C_dash):
	all_catgs = list(set(C).union(C_dash))
	all_catgs.sort()
	catg_mapping ={catg:i for i,catg in enumerate(all_catgs)}
	return catg_mapping
...
#Summary and Patience objects

class Summ(object):
	"""docstring for ScalarSumm"""
